...
contract KycOracleReceiverTest is Test {
    ...
    function test_MetadataValidation_RevertsOnAuthorMismatch() public {
        ...
        bytes memory report = abi.encode(requestIdHash, wallet, uint64(block.timestamp));
        bytes memory metadata = _buildMetadata(bytes32("workflow-1"), bytes10("sila-layer001"), outsider);
    ...
    function test_MetadataValidation_RevertsOnWorkflowIdMismatch() public {
        ...
        bytes memory metadata = _buildMetadata(receivedWorkflowId, bytes10("sila-layer001"), workflowOwner);
    ...
    function test_MetadataValidation_AllowsMatchingAuthorAndWorkflowName() public {
        receiver.setExpectedAuthor(workflowOwner);
        receiver.setExpectedWorkflowName("Sila LayerKYCWorkflow");
